    ...
    <div className="h-[52px] flex items-center justify-between px-10 border-b border-border w-full">
      <div className="flex items-center w-[260px]">
        <NavLink to="/" className="group flex items-center gap-3 text-foreground">
          <Logomark />
          <span className="font-serif-headline text-[16px] leading-none tracking-[-0.02em] opacity-0 translate-y-2 transition-all duration-200 ease-out group-hover:opacity-100 group-hover:translate-y-0 group-hover:delay-500 font-semibold">
            Shmøergh
          </span>
        </NavLink>
      </div>
