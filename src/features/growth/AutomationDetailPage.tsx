...
export function AutomationDetailPage() {
  ...
  return (
    <div className="h-full bg-background flex flex-col pt-[52px]">
      <header className="fixed top-0 left-0 right-0 z-50 h-[52px] flex items-center justify-between px-10 border-b border-border bg-background">
        <button
          type="button"
          onClick={() => navigate('/growth/automations')}
